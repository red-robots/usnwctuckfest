<?php
/*
 * Template Name: Top Level Touchable
 * Author: Fritz Healy
 * Version: 1.0
 */
 ...
 */
 get_template_part('loop','tileTouchable');
 display_loop_tile_touchable(array('post_parent'=>$post->ID,'post_type'=>'page','order'=>'ASC','posts_per_page'=>'-1'));
?>
