	    			...
	    			?>">
						...
						if($days){
							if(strcmp($query->post->post_name,"tuck-fest-prep-week-schedule")==0){
								echo "<p><span class='time'>Wednesday, April 13<sup>th</sup></span></p>";
								...
								echo "<p><span class='time'>Monday, April 18<sup>th</sup></span></p>";
								...
								echo "<p><span class='time'>Wednesday, April 20<sup>th</span></sup></p>";
								echo "<p><a href='http://tuckfest.org/competitions-demos/tuck-fest-prep-week/#miles-for-lunch-with-flywheel'>Miles For Lunch With Flywheel</a></p>";
								echo "<p><a href='http://tuckfest.org/competitions-demos/tuck-fest-prep-week/#noda-brewing-run-club'>NoDa Brewing Run Club</a></p>";
							}
             						else { 
	             						$query_tile=new WP_Query(array('category__in'=>$days,'post_type'=>'post','order'=>'ASC','posts_per_page'=>'-1'));
